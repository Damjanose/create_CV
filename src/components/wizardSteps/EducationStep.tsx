...
const EducationStep: React.FC<EducationStepProps> = ({
    ...
    if (Platform.OS === "android") {
      ...
      if (selectedDate) {
        ...
        setEducation((prev) => {
          const newEdu = [...prev];
          if (type === "start") {
            newEdu[index] = { ...newEdu[index], startDate: dateString };
          } else {
            newEdu[index] = { ...newEdu[index], endDate: dateString };
          }
          return newEdu;
        });
      }
  ...
  return (
    <View style={formStyles.container}>
        ...
        >
          ...
          <View style={formStyles.dateRow}>
            <TouchableOpacity
              ...
              onPress={() => {
                setTempPickerDate(formatDate(edu.startDate));
            ...
            >
              ...
              <Text
                style={[
                  ...
                  { color: edu.startDate ? (isDark ? "#FFF" : "#222") : (isDark ? "#888" : "#999") },
                ]}
              >
            ...
            <TouchableOpacity
              style={[
                formStyles.dateButton,
                {
                  backgroundColor: isDark ? "rgba(79, 142, 247, 0.15)" : "rgba(25, 118, 210, 0.1)",
                  borderColor: isDark ? "rgba(79, 142, 247, 0.3)" : "rgba(25, 118, 210, 0.2)",
                  opacity: edu.ongoing ? 0.5 : 1,
                },
              ]}
              onPress={() => {
                if (!edu.ongoing) {
                  setTempPickerDate(formatDate(edu.endDate));
            ...
            >
              ...
              <Text
                style={[
                  formStyles.dateButtonText,
                  { color: edu.ongoing ? (isDark ? "#888" : "#999") : (edu.endDate ? (isDark ? "#FFF" : "#222") : (isDark ? "#888" : "#999")) },
                ]}
              >
                {edu.ongoing ? "Present" : (edu.endDate || "End Date")}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              setEducation((prev) => {
                const newEdu = [...prev];
                const isOngoing = !newEdu[idx].ongoing;
                newEdu[idx] = { 
                  ...newEdu[idx], 
                  ongoing: isOngoing,
                  endDate: isOngoing ? "" : newEdu[idx].endDate,
                };
                return newEdu;
              });
            }}
          ...
          <View style={formStyles.inputContainer}>
            ...
            <View style={formStyles.textAreaContainer}>
              <TextInput
                ...
                placeholder="Education description, achievements, coursework..."
      ...
      {Platform.OS === "android" && showStartPicker !== null && education[showStartPicker] && (
        <DateTimePicker
          value={formatDate(education[showStartPicker].startDate)}
          mode="date"
          display="default"
          onChange={(event, date) => {
      ...
      {Platform.OS === "android" && showEndPicker !== null && education[showEndPicker] && showStartPicker === null && (
        <DateTimePicker
          value={formatDate(education[showEndPicker].endDate)}
          mode="date"
          display="default"
          onChange={(event, date) => {
      ...
      {Platform.OS === "ios" && showStartPicker !== null && education[showStartPicker] && (
      ...
      {Platform.OS === "ios" && showEndPicker !== null && education[showEndPicker] && (
        <Modal transparent animationType="slide" visible>
